...
- At that closure, before staging, append the accepted Task's `.ai/contracts/STATE.md#run-ledger` line; when Git is unusable, append it at the accepted transition instead. This is a silent artifact projection, never user-visible output, a choice, or a reason to stop.
